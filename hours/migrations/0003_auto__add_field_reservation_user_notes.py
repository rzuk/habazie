...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reservation.user_notes'
        db.add_column(u'hours_reservation', 'user_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reservation.user_notes'
        db.delete_column(u'hours_reservation', 'user_notes')
